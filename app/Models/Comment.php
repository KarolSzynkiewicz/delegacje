...
class Comment extends Model implements TaskSubject
{
    ...
    public function commentableIcon(): string
    {
        ...
        return match (true) {
            ...
            $morph instanceof Company => 'bi-building',
    ...
    public function commentableShowUrl(): ?string
    {
        ...
        return match (true) {
            ...
            $morph instanceof Company => route('companies.show', $morph),
    ...
    public function notificationContextLabel(): string
    {
        ...
        return match (true) {
            ...
            $morph instanceof Company => filled($morph->name) ? (string) $morph->name : 'Spółka #'.$morph->id,
