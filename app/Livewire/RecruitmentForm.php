...
class RecruitmentForm extends Component
{
    ...
    public string $referral_source_detail = '';
    ...
    protected function validReferralSourceValues(): string
    {
        return implode(',', array_column(
            array_filter(RecruitmentReferralSource::cases(), fn ($c) => $c->isPublicForm()),
            'value'
        ));
    }
    ...
    {
        $needsDetail = $this->referral_source !== ''
            && ($src = RecruitmentReferralSource::tryFrom($this->referral_source))
            && $src->requiresDetail();
        ...
        return [
            ...
            'referral_source' => 'nullable|string|in:' . $this->validReferralSourceValues(),
            'referral_source_detail' => $needsDetail ? 'required|string|max:200' : 'nullable|string|max:200',
    ...
    protected array $messages = [
        ...
        'referral_source_detail.required' => 'Podaj szczegóły.',
    ...
    public function submit(): void
    {
        ...
        DB::transaction(function () {
            ...
            $src = $this->referral_source ? RecruitmentReferralSource::tryFrom($this->referral_source) : null;
            $detail = ($src?->requiresDetail() && $this->referral_source_detail !== '')
                ? $this->referral_source_detail
                : null;
