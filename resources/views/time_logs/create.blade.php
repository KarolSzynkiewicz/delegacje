...
<div class="container">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <h1>Dodaj Nowy Zapis Czasu Pracy</h1>
            ...
            <form action="{{ route('time_logs.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.5" class="form-control @error('hours_worked') is-invalid @enderror" id="hours_worked" name="hours_worked" value="{{ old('hours_worked') }}">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">Dodaj Zapis</button>
