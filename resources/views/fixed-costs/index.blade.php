<x-app-layout>
    ...
    <x-ui.card>
        ...
        <div class="tab-content">
            @if($activeTab === 'templates')
                <div class="tab-pane fade show active" id="templates-tab" role="tabpanel">
            ...
            @else
                <div class="tab-pane fade show active" id="entries-tab" role="tabpanel">
                    <livewire:fixed-cost-entries-table />
                </div>
            @endif
        </div>
    </x-ui.card>
