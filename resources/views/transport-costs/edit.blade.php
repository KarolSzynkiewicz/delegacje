<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="fw-semibold fs-4 mb-0">Edytuj Koszt Transportu</h2>
            <x-ui.button variant="ghost" href="{{ route('transport-costs.show', $transportCost) }}">
                ...
                <form method="POST" action="{{ route('transport-costs.update', $transportCost) }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <x-ui.input 
                                ...
                                name="amount" 
                                label="Kwota"
                                value="{{ old('amount', $transportCost->amount) }}"
                                step="0.01"
                                min="0"
                                required="true"
                            />
                    ...
                    <div class="mb-3">
                        <x-ui.input 
                            ...
                            name="cost_date" 
                            label="Data kosztu"
                            value="{{ old('cost_date', $transportCost->cost_date->format('Y-m-d')) }}"
                            required="true"
                        />
                    </div>
                    ...
                    <div class="mb-3">
                        <x-ui.input 
                            ...
                            name="description" 
                            label="Opis"
                            value="{{ old('description', $transportCost->description) }}"
                        />
                    </div>
                    ...
                    <div class="mb-4">
                        <x-ui.input 
                            ...
                            name="notes" 
                            label="Notatki"
                            value="{{ old('notes', $transportCost->notes) }}"
                            rows="3"
                        />
                    </div>
