                ...
                <form method="POST" action="{{ route('transport-costs.store') }}">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="currency" value="{{ old('currency', 'PLN') }}" maxlength="3" required
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="cost_date" value="{{ old('cost_date', date('Y-m-d')) }}" required
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                    </div>
                    ...
                    <div class="flex items-center justify-end">
                        <a href="{{ route('transport-costs.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-3">
                            Anuluj
                        </a>
