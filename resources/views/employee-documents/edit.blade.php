                                ...
                                >
                                    ...
                                    @foreach($documents as $document)
                                        <option
                                            ...
                                            {{ old('document_id', $employeeDocument->document_id) == $document->id ? 'selected' : '' }}
                                        >
                                            {{ $document->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="mb-3" id="company-field">
                                ...
                                >
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->id }}" {{ (string) old('company_id', $employeeDocument->company_id) === (string) $company->id ? 'selected' : '' }}>
                                            {{ $company->name }}
                                        </option>
                                    @endforeach
                                </x-ui.input>
