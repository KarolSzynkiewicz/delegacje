<x-app-layout>
    <x-slot name="header">
        <h2 class="fw-semibold fs-4 mb-0">Edytuj Ocenę</h2>
    </x-slot>

    <div class="row justify-content-center">
        <div class="col-lg-8">
            <x-ui.card label="Edytuj Ocenę">
                <x-ui.errors />

                <form action="{{ route('employee-evaluations.update', $employeeEvaluation) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="employee_id" class="form-control @error('employee_id') is-invalid @enderror" required>
                            ...
                            @foreach($employees as $employee)
                                <option value="{{ $employee->id }}" {{ old('employee_id', $employeeEvaluation->employee_id) == $employee->id ? 'selected' : '' }}>
                                    {{ $employee->full_name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input 
                                ...
                                min="1" 
                                max="10" 
                                value="{{ old('engagement', $employeeEvaluation->engagement) }}"
                                required
                            >
                            @error('engagement')
                                <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input 
                                ...
                                min="1" 
                                max="10" 
                                value="{{ old('skills', $employeeEvaluation->skills) }}"
                                required
                            >
                            @error('skills')
                                <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input 
                                ...
                                min="1" 
                                max="10" 
                                value="{{ old('orderliness', $employeeEvaluation->orderliness) }}"
                                required
                            >
                            @error('orderliness')
                                <span class="invalid-feedback">{{ $message }}</span>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input 
                                ...
                                min="1" 
                                max="10" 
                                value="{{ old('behavior', $employeeEvaluation->behavior) }}"
                                required
                            >
                            @error('behavior')
                                <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="mb-3">
                        <x-ui.input 
                            ...
                            name="notes" 
                            label="Uwagi"
                            value="{{ old('notes', $employeeEvaluation->notes) }}"
                            rows="4"
                        />
                    </div>
