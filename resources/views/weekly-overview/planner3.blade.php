                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="dark-card">
                            ...
                            <x-ui.button variant="ghost" href="{{ route('assignments.create', ['project_id' => $project->id, 'date_from' => $weeks[0]['start']->format('Y-m-d'), 'date_to' => $weeks[0]['end']->format('Y-m-d')]) }}" class="w-100 mt-4 py-3 border-2 border-dashed">
