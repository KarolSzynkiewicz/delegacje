        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('locations.update', $location) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="address" name="address" value="{{ old('address', $location->address) }}" required>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">Zaktualizuj Lokalizację</button>
