<div>
            ...
            <x-ui.card>
                ...
                <div class="row g-3">
                    @foreach($vehicles as $vehicle)
                        @php
                            $isSelectedVehicle = isset($selectedVehicleId) && (int)$selectedVehicleId === (int)$vehicle['id'];
    ...
    // Drop - vehicle drop zone (same pattern as step 1)
            ...
            zone.addEventListener('click', function(e) {
                ...
                if (!draggedEmployeeId) {
                    ...
                    if (unassignedEmployees.length === 0) {
                        alert('Wszyscy pracownicy mają już przypisane pojazdy. Usuń przypisanie aby zmienić.');
                        return;
                    }
