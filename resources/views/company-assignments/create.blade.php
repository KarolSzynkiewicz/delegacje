<x-app-layout>
    <x-slot name="header">
        <x-ui.page-header title="Dodaj Przypisanie do Spółki">
            <x-slot name="left">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <x-ui.card label="Nowe przypisanie">
                <x-ui.errors />
                ...
                <form method="POST" action="{{ route('company-assignments.store') }}">
                    ...
                    <div class="mb-3">
                        <x-ui.input type="select" name="company_id" label="Spółka" required="true">
                            ...
                            @foreach($companies as $comp)
                                <option value="{{ $comp->id }}" {{ old('company_id', $company?->id) == $comp->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <x-ui.input type="date" name="start_date" label="Data od" value="{{ old('start_date') }}" required="true" />
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-4">
                        <x-ui.input type="textarea" name="notes" label="Notatki" value="{{ old('notes') }}" rows="4" />
                    </div>
