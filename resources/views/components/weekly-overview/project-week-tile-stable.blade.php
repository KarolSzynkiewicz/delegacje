                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        @if($stability['assigned_employees']->isNotEmpty())
                            ...
                            <div class="mt-2">
                                <a href="{{ route('assignments.create', ['project_id' => $project->id, 'date_from' => $weekStart->format('Y-m-d'), 'date_to' => $weekEnd->format('Y-m-d')]) }}" class="btn btn-sm btn-primary w-100">
